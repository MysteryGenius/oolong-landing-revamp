...
var FrameManager = class {
  ...
  async nextFrame(timestamp) {
    try {
      ...
      container.lastFrameTime ?? (container.lastFrameTime = timestamp);
...
var Loader = class {
  ...
  async loadOptions(params) {
    const tagId = params.tagId ?? `tsparticles${Math.floor(getRandom() * 1e4)}`, { index, url: jsonUrl, remote } = params, options = remote ? await getDataFromUrl(jsonUrl, index) : params.options;
